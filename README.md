...
2. **Senior hour window** — `SeniorDiscountStrategy` uses named constants `SeniorHourStart = 7` and `SeniorHourEnd = 9` with the condition `hour >= SeniorHourStart && hour < SeniorHourEnd`. This covers 7:00–8:59 AM (hours 7 and 8 inclusive).
